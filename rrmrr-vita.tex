...
\newcommand{\marginhead}[1]{%
	...
	\vskip-1.5ex\relax% now lining at TOP with body text, change to 1.6ex to be lining at BOTTOM (of the same line)
}%
...
\begin{minipage}[t]{2.3in}
 \flushright {\scriptsize 
      \href{https://www.worldbank.org/en/about/unit/unit-dec}{\scshape Development Research Group}  \\
      The World Bank        \\
      1818 H Street N.W.    \\
...
\ind Research Assistant, Development Research Group, The World Bank, 2021--.
...
\noindent\emph{\textbf{Books} \vspace{0.05in}}
...
\ind The World Bank. \emph{Instructor}. 2020--. \newline \texttt{\href{https://github.com/worldbank/dime-r-training}{R training}}. 
...
\ind Development Research Group -- The World Bank, 2021--
