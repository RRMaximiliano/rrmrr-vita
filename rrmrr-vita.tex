...
\StrLeft{\commithash}{6}[\commitsix]

% Build the URL to this commit based on the information we now have
\newcommand{\commiturl}{\texttt{\commitsix}}
...
\begin{minipage}[t]{2.3in}
 \flushright {\scriptsize 
      \href{https://www.worldbank.org/en/about/unit/unit-dec}{Development Economics}  \\
      The World Bank        \\
      1818 H Street N.W.    \\
...
\begin{minipage}[t]{1.9in}
  ...
  \texttt{\href{https://rrmaximiliano.github.io}{\myweb}} \, \faGlobe \\
  \texttt{\href{https://github.com/RRMaximiliano}{\mygithub}} \, \faGithub \\
  \texttt{\href{\myemail}{\myemail}} \, \faEnvelope \\
  }
\end{minipage}
...
%% Name 
\noindent{\LARGE\scheader \textsc{rony rodriguez-ramirez}}
\reversemarginpar
