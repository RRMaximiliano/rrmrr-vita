...
\geometry{textheight=9.25in, textwidth=7.25in,bottom=.75in,top=.75in}
...
\setmonofont[Mapping=tex-text,Scale=0.85]{Essential PragmataPro}
...
\fancypagestyle{empty}{%
  ...
  \fancyfoot[R]{{\normalsize \texttt{Last Updated: \today}}}
}
...
\item ``Supporting Mental Health Through the Promotion of Psychosocial Support in Armenian schools,'' with Lelys Dinarte-Diaz, and Renata Lemos.
\end{enumerate}
...
\begin{itemize}
\item \textbf{Research Analysist, The World Bank} \hfill 2020-Present \newline
{\small Worked with the Development Research Group (Poverty and Inequality) and DIME on experimental and impact evaluation projects, including: Adaptive interventions for contraceptive uptake in Cameroon, Tech-enabled tutoring for adolescent learning in Ukraine, Mental health and psychosocial support in Armenian schools, Land rights and irrigation productivity in Rwanda.}
\item \textbf{Research Assistant, ITAM - Innovations for Poverty Action and University of Oxford} \hfill 2019-2020 \newline
{\small Assisted Professors Mauricio Romero and Nathaniel Lane on impact evaluations and governance research, including: Outsourcing schools in Liberia and Civil society and multinational governance across countries.}
\end{itemize}
...
\section*{Seminars \textit{\&} Conference Presentations}
	2024.	NEUDC, Northeastern University; Economics of Education Seminar, Harvard University. \newline 2023. Stata Conference. \newline 2021. The World Bank DIME--KDI School. \newline 2019. Allied Social Science Association (ASSA--AER) meetings.
...
\section*{Skills}
\begin{itemize}
\item \textbf{Software.} Stata, R, \LaTeX, Git(Hub), ODK (SurveyCTO), Python.
\item \textbf{Language.} Spanish (native), English (fluent), French
